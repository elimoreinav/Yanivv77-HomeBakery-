...
public class ClientOrders extends Order  implements Ordering {
	...
	/**
	 * Instantiates a new client orders.
	 *
	 * @param daysUntillready the days untillready
	 * @param client the client
	 * @param productsArray the products array
	 */
	public ClientOrders(int daysUntillready, Client client,ArrayListProducts productsArray) {
